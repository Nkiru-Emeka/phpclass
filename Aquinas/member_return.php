...
if(isset($_POST['submit']))
{
    ...
    $insert= mysqli_query($connect1, "insert into member_return
    (member_id, date_return)
...
<p>
    <div class="col">date of return <input type="date" name="date_return"  placeholder="yyyy/mm/dd"></div>
</p>
