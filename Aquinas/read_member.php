...
<body>
    ...
    <table width= "800" border="1" align="centre"> 
        <tr>
            ...
            <td width="85">Member Edit</td>
            <td width="85">Delete Member </td>
            <td width="85">View Member</td>
        ...
        <tr>
            ...
            <td><a href="update_member.php?id=<?php echo $id[$s] ?>">Edit</a></td>
            <td onclick="return confirm ('Are you sure to delete?')"><a href="update_member.php?id=<?php echo $id[$s]?>">Delete</a></td>
            <td><a href="view_member.php?id=<?php echo $id[$s] ?>">view</a></td>
            <td><a href="change_member_status.php?id=<?php echo $id[$s] ?>">Change Status</a></td>
        </tr>
        <?php  } ?>
    </table>
