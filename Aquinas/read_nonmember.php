...
<body>
    <table width= "800"  align="centre" height="40">
        <tr>
            <td>List of Non-active members in <?php echo $memberzonez ?></td>
        </tr>
    </table>
    <table width= "800" border="1" align="centre"> 
        <tr>
            ...
            <td width="85">Reason for Movement</td>
            <td width="85">View Member</td>
            <td width="85">Change Status</td>
            </tr>
        ...
        <tr>
            ...
            <td><?php echo $member_status[$s] ?></td>
            <td><a href="view_member.php?id=<?php echo $id[$s] ?>">view</a></td>
            <td><a href="member_return.php?id=<?php echo $id[$s] ?>">Change Status</a></td>
        </tr>
        <?php  } ?>
    </table>
